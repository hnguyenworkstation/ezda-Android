...
import us.hungnguyen.ezda.Animations.RelativeLayoutParamsEvaluator;
import us.hungnguyen.ezda.MainActivity;
        ...
        for (View v : mCardCollection) {
            ...
            */
            ...
            if (index == 0)// setting 0 used to add different layout shadow...
                v.setBackground(MainActivity.context.getResources().getDrawable(R.drawable.card_stack_bg_shadow3));
            else if (index == 1)
                v.setBackground(MainActivity.context.getResources().getDrawable(R.drawable.card_stack_bg_shadow2));
            else if (index == 2)
                v.setBackground(MainActivity.context.getResources().getDrawable(R.drawable.card_stack_bg_shadow));
        }
    }
